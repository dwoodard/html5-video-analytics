...
var beforeAfter = {
    beforeEach: function (assert) {
            // assert.ok(va.players.length == 0, "0 players");
        // if(va){
        // }
        buildDom();
    },
